    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="${pageContext.request.contextPath}/CommendServlet?cid=${user.cid}ß"><span class="glyphicon glyphicon-heart"></span> 为你推荐</a></li>
                <li class="dropdown">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <img style="width: 300px;height: 300px;margin: 0em" src="img/users/${user.cid}.jpg" class="img-circle">
        </div>
        <div class="col-md-8">
