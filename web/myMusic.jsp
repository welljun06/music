...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4  text-right" style="margin-top: 20px">
            <button type="button" class="btn btn-default" onclick="{location.href='${pageContext.request.contextPath}/AddListServlet?cid=${user.cid}'}" >创建歌单</button>
        <a  href=""><p></p></a>
        </div>
    </div>
    <div class="row table-responsive">
        <table class="table table-condensed table-striped">
            ...
            <c:forEach var="c" items="${requestScope.songList }" varStatus="status">
                <tr>
                    <td style="width: 60px;height: 60px"><div style="width: 60px;height: 60px"><img style="width: 60px;height: 60px" src="img/lists/${c.lid}.jpg" class="img-rounded img-responsive" alt="Responsive image"></div></td>
                    <td style="vertical-align: middle;"><a href="${pageContext.request.contextPath}/SongListInfoServlet?cid=${user.cid}&lid=${c.lid}&lname=${c.lname}">${c.lname}</a></td>
                    <td style="vertical-align: middle;">${c.ltype}</td>
                    <td style="vertical-align: middle;">${c.lcount}</td>
                    <td style="vertical-align: middle;">${c.ltime}</td>
                    <td style="vertical-align: middle;">${c.linfo}</td>
                    <td style="vertical-align: middle;"><a href="${pageContext.request.contextPath}/DelListServlet?cid=${user.cid}&lid=${c.lid}"><span class="glyphicon glyphicon-remove"></span></a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
        ...
        <table class="table table-condensed table-striped">
            ...
            <c:forEach var="c" items="${requestScope.favSongList }" varStatus="status">
                <tr>
                    ...
                    <td style="vertical-align: middle;">${c.ltime}</td>
                    <td style="vertical-align: middle;">${c.linfo}</td>
                    <td style="vertical-align: middle;"><a href="${pageContext.request.contextPath}/TakeOffListServlet?cid=${user.cid}&lid=${c.lid}"><span class="glyphicon glyphicon-remove"></span></a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
